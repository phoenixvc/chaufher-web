  ...
  return <div className="relative pt-16 pb-12 px-6">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="bg-[#d4af37] backdrop-blur-md p-2.5 rounded-full border border-white/30 hover:bg-[#ffdd5c] transition-colors shadow-lg active:scale-95" aria-label="Emergency assistance">
          ...
          <div className="bg-white/20 backdrop-blur-md p-2 rounded-full border border-white/30">
            <Zap className="text-[#d4af37] fill-[#d4af37]" size={20} />
          </div>
        </div>
      </div>
      ...
      bounce: 0.4
        ...
        <div className="h-1 w-24 bg-white/30 rounded-full mb-6 overflow-hidden">
          <motion.div className="h-full w-1/2 bg-[#d4af37]" animate={{
          x: ['-100%', '200%']
        }} transition={{
          repeat: Infinity,
          duration: 1.5,
