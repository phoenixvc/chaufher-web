      ...
      <div className="space-y-8">
        ...
        <div className="space-y-6">
          <div className="border-b border-gray-200 pb-2">
            ...
            <input type="text" defaultValue="128 Market St, San Francisco" className="w-full text-xl text-[#1a1a1a] placeholder-gray-300 outline-none font-serif bg-transparent" />
          </div>
          <div className="border-b border-gray-200 pb-2">
            <label className="block text-xs text-[#2d5016] font-medium mb-2 uppercase tracking-widest">
              To
