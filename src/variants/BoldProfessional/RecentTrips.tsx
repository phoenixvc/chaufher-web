...
export function RecentTrips() {
  return <section className="py-6 px-6 border-t border-white/5">
      ...
      <div className="space-y-3">
        ...
        delay: index * 0.1
      }} className="w-full bg-[#232946] rounded-lg p-4 border border-white/5 hover:border-[#4ecdc4]/30 transition-all text-left group">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  <div className="w-2 h-2 bg-[#ff6b6b] transform rotate-45"></div>
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <div className="p-1.5 rounded bg-white/5 group-hover:bg-[#4ecdc4] transition-colors">
                  <RotateCcw size={14} className="text-gray-400 group-hover:text-[#1a1f3a] transition-colors" />
                </div>
              </div>
            </div>
          </motion.button>)}
